<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            <div class="form-group">
                <label for="message">Enter your message here:<br>
                    <div class="text-left small"><div class="alert alert-warning" style="padding:5px;">Contact a mod to delete your comments. Editing comments to be defamatory etc is not allowed. Editing comments on sales pages will result in a sales ban.</div></div></label>
